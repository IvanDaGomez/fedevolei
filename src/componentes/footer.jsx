      ...
      <>
        <footer>
          <div className="footer-section">
            <img src="/lisanvolei.png" alt="lisanvolei" />
          </div>
          <div className="footer-section organizador">
            <a href="" className="link"><h3>Registros financieros</h3></a>
          ...
          <div className="footer-section">
            ...
            <ul>
              <li>Correo: ligasantandereanadevoleibol@gmail.com</li>
              <li>Teléfono: +57 318 567 0090</li>
            </ul>
